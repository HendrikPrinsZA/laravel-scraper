...
/**
 * Default client for Roach
 *
 * - Cloned from vendor/roach-php/core/src/Http/Client.php
 * - Configured in config/roach.php
 *
 * Why?
 * - Might want to send requests via proxies
 */
class RoachClient implements ClientInterface
{
